<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="MuzikKursuKayitSitesi.Default" %>
...
<head>
    <title>Sisteme Hoşgeldiniz</title>
...
<body>
    <h1 class="w3layouts">Müzik Okulu Kayıt Sayfası</h1>
    <div class="clear"></div>
        ...
        <div class="form_w3layouts">
            <form action="#" method="post" class="agile_form" runat="server">
                ...
                <div class="checkin agileits-left">
                    <asp:TextBox ID="TxtDogumTarihi" runat="server" placeholder="Doğum Tarihi(GG-AA-YYYY)"></asp:TextBox>
                </div>
